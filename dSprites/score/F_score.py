...
class FStatMetric():
    ...
    def evaluate(self):
        ...
        #print ("data_gt_latent_ids", data_gt_latent_ids)

        #print ("data_gt_latent_ids", data_gt_latent_ids.shape)

        data_inference_discrete = self.discretize(data_inference)

        #print ("data_inference_discrete", data_inference_discrete.shape)
        ...
        print ("modu_score", modu_score)

        print ("expl_score", expl_score)
...
F_score = FStatMetric(metric_data)
F_score.evaluate()
